...
do {
  ...
  let myTruck = Truck(licensePlateNumber: licensePlateNumber, colour: colour, maxSpeed: truckMaxSpeed, numberOfTires: numberOfTires)
  ...
  let myBike = Bike(colour: colour, maxSpeed: bikeMaxSpeed)
